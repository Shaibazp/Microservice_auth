...
public class RestaurantOrderDAO 
{
	public OrderResponseDTO getOrders(String orderId) {
		System.out.println(orderId+" iiiiiiiiiiii "+generateRandomOrders().get(orderId));
    ...
    private Map<String, OrderResponseDTO> generateRandomOrders() {
        ...
        orderMap.put("35fds63", new OrderResponseDTO("35fds63", "VEG-MEALS", 1, 199, new Date(), "READY", 15));
